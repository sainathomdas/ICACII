  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar " style="background-color: #000009" >
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="dropdown-menu dropdown-default" aria-labelledby="navbarDropdownMenuLink-333">
       ...
       <a class="dropdown-item"  href="<?php echo base_url('assets/Programme Schedule - ICACII 2019.pdf');?>" target="_blank">Programme Schedule</a>
       ...
       <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="<?php echo base_url('assets/ICACII 2019 Paper Presentation Schdule.pdf');?>" target="_blank">Presentation Schedule</a>
      </div>
