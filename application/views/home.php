...
<!--  <div class="jumbotron-fluid">
  ...
  <div class="ribbon col-md-12">
   <strong class="ribbon-content " style="font-size: 24px;">Expected VIPs</strong>
 </div>
...
<center>
    ...
    <div>
      ...
      <div class="our-team">
        ...
        <div class="team-content">
          <h3 style="color:black;"><strong>VISHNU VARDHAN</strong></h3>
        </div>
    </div>
  ...
  <div> 
       <div class="our-team">
        ...
        <div class="team-content">
          <h3 style="color:black;"><strong>Salman Abdul moiz</strong></h3>
        </div>
    </div>
   </div>
  <div> 
      <div class="our-team">
        ...
        <div class="team-content">
          <h3 style="color:black;"><strong>Rajeev Wankar</strong></h3>
        </div>
    </div>
   </div>
  <div> 
  ...
  <div> 
      <div class="our-team">
        ...
        <div class="team-content">
          <h3 style="color:black;"><strong>J.Sasi Kiran</strong></h3>
        </div>
    </div>
   </div>
    ...
    <div> 
      <div class="our-team">
        ...
        <div class="team-content">
          <h3 style="color:black;"><strong>A.V. Krishna Prasad.</strong></h3>
        </div>
    </div>
   </div>
      ...
      <div class="our-team">
        ...
        <div class="team-content">
          <h3 style="color:black;"><strong>A.V.N. Krishna</strong></h3>
        </div>
    </div>
   </div>
