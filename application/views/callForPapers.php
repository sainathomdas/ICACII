...
<div class="jumbotron ml-sm-1 mr-sm-1 ml-lg-3 mr-lg-3 p-3 pl-4 pr-4" style="border-radius: 10px;">
  <div class="jumbotron hoverable">
    ...
    <p class="p-2 text-justify text-body " style="font-family: 'Lato', sans-serif;">
      ...
      <center>
        <a href="https://easychair.org/conferences/?conf=icacii2019" target="_blank" class="btn btn-success">Submit your paper now</a>
      </center>
    </p>
    <br>
  ...
  <h5 style="color: black;" class="ml-lg-3"><b>IMPORTANT NOTE FOR PAPER PUBLICATION</b></h5>
  <div class="container-fluid"><ul> 
    <li> Every Paper accepted by the Paper Publication Review Committee must be registered by
    at least one author.</li>
    <li>Each Accepted &amp; Registered Participants for Paper Presentation will be provided
      Presentation &amp; Participation Certificate. Additionally Certificate of Acceptance will be
    handed over to all the authors.</li>
    <li>The registration fee covers conference kit, lunches &amp; refreshments, and can attend all the
    conference proceedings.</li>
    <li>Co-authors can attend and avail participation certificates by paying Rs.3000 /- , provided
    one author of the same paper is registered by paying full registration fee.</li>
...
<h5 style="color: black;" class="ml-lg-3"><b>IMPORTANT NOTE FOR POSTER PRESENTATION</b></h5>
<div class="container-fluid"><ul> 
<li> Depending on the level of research content in the submitted papers, the reviewers may
  recommend few papers to be considered for Poster Presentation. This facility is given to
  the researchers in order to get exposed, improve and enhance their research skills.</li>
  <li> Each Poster participant should pay registration fee of Rs. 1500 (Subsidized fee)</li>
